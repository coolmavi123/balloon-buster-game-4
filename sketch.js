...
if (arrowGroup.isTouching(pinkB)) {
  ...
  //write text for instructions
  textSize(18);
 
  strokeWeight(50);
  text("Hit the PINK balloon to win 1 points!",65,200);
  text("Hit the BLUE balloon to win 2 points!! ",65,230);
  text("Hit the GREEN balloon to win 3 points!!!",45,260);
  text(" CAREFUL!!HIT THE RED BALLOON AND U LOSE:(",-3,290);
